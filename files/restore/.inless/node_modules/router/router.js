...
var render = function render(layout, params) {
	var minify = arguments.length <= 2 || arguments[2] === undefined ? false : arguments[2];
...
var Router = (function () {
	...
	_createClass(Router, [{
		...
		value: function rxReact(layout) {
			// layout['mixins'] = [];
			layout['mixins'] = require('reactRoute/mixins.js').concat([{ isLayout: true }]);
