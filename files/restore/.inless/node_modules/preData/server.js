...
var appConfigs = (0, _configs2['default'])('app');
...
var server = require(_path2['default'].resolve('./application' + appConfigs.react.server)) || function () {};
...
var Request = function Request(path, source) {
	...
	var files = arguments.length <= 5 || arguments[5] === undefined ? {} : arguments[5];
	...
	session = typeof session == 'string' ? new _session2['default'](session) : session;
	var req = {
		id: id,
		method: method,
		query: query,
...
var Res = (function () {
	function Res(res, next, end, redirect, title) {
	...
	_createClass(Res, [{
		key: 'setStatus',
		value: function setStatus(value, message) {
			this.__status = value;
...
var Response = function Response(res, next, end, redirect, title) {
...
var PreData = (function () {
	function PreData(routes) {
		_classCallCheck(this, PreData);

		var router = _express2['default'].Router();
		this.router = router;
		router.post(appConfigs.react.preDataPath || '/preData', function (request, response, next) {
			try {
